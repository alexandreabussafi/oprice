...
const Documents: React.FC<DocumentsProps> = ({ data, updateData }) => {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-5 space-y-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                        ...
                        <textarea
                            value={documents.technicalAssumptions}
                            onChange={(e) => updateDoc('technicalAssumptions', e.target.value)}
                            className="w-full h-24 p-4 bg-amber-50/50 border border-amber-100 rounded-lg text-sm text-slate-700 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none resize-none"
                            placeholder="Ex: O cliente fornecerá energia elétrica e vestiários..."
                        />
                    </div>
                </div>
